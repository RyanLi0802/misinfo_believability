...
if __name__ == "__main__":
    ...
    user_features = ['user_followers_count', 'user_friends_count', 'user_favourites_count', 'user_listed_count',
                     'user_statuses_count']
    ...
    toxicity_features = ["toxicity", "severe_toxicity", "obscene", "identity_attack", "insult", "threat",
                         "sexual_explicit"]
